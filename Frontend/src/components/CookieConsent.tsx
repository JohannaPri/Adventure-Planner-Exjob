...
const CookieConsent = () => {
    ...
    const handleReject = () => {
        Cookies.set('cookiesConsent', JSON.stringify({
            essential: false,
            analytics: false,
            marketing: false,
        }), { expires: 365 });
      ...
      <div className="z-50 max-w-max fixed bottom-4 right-4 bg-slateGray text-white py-6 px-8 rounded-lg shadow-lg flex flex-col md:flex-row items-center gap-4">
        {!showCustomize ? (
          <>
            ...
            <p className="text-lg font-bold mb-2 tracking-wide">We Travel with Cookies!</p>
            ...
            <div className="inline-flex flex-col gap-2.5 px-4 mx-auto">
              ...
              >
                <strong className="block font-semibold mb-2 tracking-wide">Accept All Cookies</strong>
            ...
            >
              <p className="block font-semibold mb-2 tracking-wide">Customize Settings</p>
            ...
            >
              <strong className="block font-semibold mb-2 tracking-wide">Reject</strong>
          ...
          <>
            <div className="flex flex-col gap-4">
              ...
              <label>
                <input type="checkbox" checked={essentialCookies} disabled /> Essential Cookies
                (Required)
              </label>
              <label>
                <input 
                    ...
                    className="mr-2" /> Analytics Cookies (Track your trip progress)
              </label>
              <label>
                <input 
                    type="checkbox" 
                    ...
                    className="mr-2" /> Marketing Cookies (Personalize offers)
              </label>
            </div>
            <button
