...
const AccommodationComponent: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col md:flex-col sm:flex-col lg:flex-row gap-4 md:gap-4">
          ...
          <div className="relative lg:w-[300px] sm:w-[100%] md:w-[360.2px] w-screen h-auto max-w-fit">
            <DatePickerComponent
