  ...
  return (
    <section className="w-full my-32 flex justify-between relative items-start h-[400px] font-poppins">
      <div className="w-full border-t-2 border-b-2 border-cloudGray2 h-[100%] absolute flex flex-col items-center justify-center md:gap-16 gap-10 px-5">
        ...
        <Text
          as="h2"
          className="lg:text-xl md:text-xl text-xl text-center text-slateGray lg:w-3/5 w-full"
        >
        ...
        <form className="flex md:flex-row flex-col items-stretch gap-2">
          <Input
            ...
            inputClass="border border-slateGray rounded-lg outline-none w-[300px] h-[50px] focus:outline-none text-slateGray pr-4 pl-9 py-1"
            type="email"
          ...
          <AttentionSeeker effect="headShake" delay={1000} duration={1500}>
            <Button
              type="submit"
              className="w-full shadow-md px-5 py-3 text-white border border-slateGray rounded-lg outline-none lg:px-7 font-extralight bg-slateGray hover:shadow-none hover:bg-black hover:text-white hover:border-black transition-all duration-300 ease-in"
            >
