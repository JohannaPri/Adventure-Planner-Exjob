...
const MyAdventures: React.FC = () => {
  ...
  /**
   * Handles the addition of a new folder to the list of folders.
   * This function is passed to the MyAdventuresInput component.
   *
   * @param folder The new folder to be added to the list.
   */
  ...
  /**
   * Handles the deletion of a folder from the list of folders.
   * This function removes the folder based on its ID.
   *
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <h1 className="flex pb-4 font-semibold text-left uppercase">
        My Adventures ({folders.length})
      </h1>
